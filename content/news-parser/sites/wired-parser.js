var wiredParser = (function() {
  var module = {};

  module.parseData = function (urlInfo) {
    // parse the data we need from yahoo news
    var regex_res = urlInfo.url.match('https://www.wired.com/.*/(.*)/$');
    var newsId = regex_res && regex_res.length == 2 ? regex_res[1] : '';
    var newsTitle = $('h1.title').text();
    var $article = $('main.article-main-component__content');
    var newsContent = '';
